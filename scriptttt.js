        ...
        document.getElementById("result").innerHTML = `
            <div class="profile">   
                ...
                <div class="profile-details">
                    ...
                    <div class="media">
                        <p>
                            <span class="media-value">${data.location || "Bilgi Yok"}</span>
                        </p>
                        <p>
                            <span class="media-value">${data.blog || "Bilgi Yok"}</span>
                        </p>
                        <p>
                            <span class="media-value">${data.twitter_username || "Bilgi Yok"}</span>
                        </p>
                        <p>
                            <span class="media-value">${data.company || "Bilgi Yok"}</span>
                        </p>
                    </div>
                </div>
            </div>`;
